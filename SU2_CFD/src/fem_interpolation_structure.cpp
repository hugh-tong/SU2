...
CFEMInterpolationDriver::CFEMInterpolationDriver(char* confFile,
  ...
  driver_config = new CConfig(config_file_name, SU2_COMPONENT::SU2_CFD, ZONE_0, nZone, nDim, false);
  ...
  for (iZone = 0; iZone < nZone; iZone++) {
    ...
    if (driver_config->GetnConfigFiles() > 0) {
      ...
      input_config_container[iZone] = new CConfig(zone_file_name, SU2_COMPONENT::SU2_CFD, iZone, nZone, nDim, true);
      output_config_container[iZone] = new CConfig(zone_file_name, SU2_COMPONENT::SU2_CFD, iZone, nZone, nDim, false);
    }
    else{
      input_config_container[iZone] = new CConfig(config_file_name, SU2_COMPONENT::SU2_CFD, iZone, nZone, nDim, true);
      output_config_container[iZone] = new CConfig(config_file_name, SU2_COMPONENT::SU2_CFD, iZone, nZone, nDim, false);
    }
  ...
  input_fem_solver = ((input_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::FEM_EULER)          ||
                      (input_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::FEM_NAVIER_STOKES)  ||
                      (input_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::FEM_RANS)           ||
                      (input_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::FEM_LES)            ||
                      (input_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM_EULER) ||
                      (input_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM_NS)    ||
                      (input_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM_RANS));
  ...
  /*--- Determine whether or not the FEM solver is used, which decides the
   type of geometry classes that are instantiated. Only adapted for single-zone problems ---*/
  output_fem_solver = ((output_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::FEM_EULER)          ||
                       (output_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::FEM_NAVIER_STOKES)  ||
                       (output_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::FEM_RANS)           ||
                       (output_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::FEM_LES)            ||
                       (output_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM_EULER) ||
                       (output_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM_NS)    ||
                       (output_config_container[ZONE_0]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM_RANS));
  ...
  output = COutputFactory::CreateOutput(MAIN_SOLVER::NEMO_NAVIER_STOKES, input_config_container[ZONE_0],nDim);
...
void CFEMInterpolationDriver::Input_Preprocessing(CConfig **config_container, CGeometry ****geometry_container, bool val_periodic) {
  ...
  for (iZone = 0; iZone < nZone; iZone++) {
    ...
    fem_solver = ((config_container[iZone]->GetKind_Solver() == MAIN_SOLVER::FEM_EULER)         ||
                  (config_container[iZone]->GetKind_Solver() == MAIN_SOLVER::FEM_NAVIER_STOKES) ||
                  (config_container[iZone]->GetKind_Solver() == MAIN_SOLVER::FEM_RANS)          ||
                  (config_container[iZone]->GetKind_Solver() == MAIN_SOLVER::FEM_LES)           ||
                  (config_container[iZone]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM_EULER) ||
                  (config_container[iZone]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM_NS)    ||
                  (config_container[iZone]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM_RANS));
...
void CFEMInterpolationDriver::Geometrical_Preprocessing(CConfig **config_container, CGeometry ****geometry_container) {
  ...
  for (iZone = 0; iZone < nZone; iZone++) {
    ...
    fea = ((config_container[iZone]->GetKind_Solver() == MAIN_SOLVER::FEM_ELASTICITY) ||
        (config_container[iZone]->GetKind_Solver() == MAIN_SOLVER::DISC_ADJ_FEM));
...
void CFEMInterpolationDriver::Solver_Preprocessing(CSolver ****solver_container, CGeometry ***geometry,
  ...
  switch (config->GetKind_Solver()) {
    case MAIN_SOLVER::TEMPLATE_SOLVER: template_solver = true; break;
    case MAIN_SOLVER::EULER : euler = true; break;
    case MAIN_SOLVER::NEMO_EULER: nemo_euler = true; break;
    case MAIN_SOLVER::NAVIER_STOKES: ns = true; heat_fvm = config->GetWeakly_Coupled_Heat(); break;
    case MAIN_SOLVER::NEMO_NAVIER_STOKES: nemo_ns = true; break;
    case MAIN_SOLVER::RANS : ns = true; turbulent = true; if (config->GetKind_Trans_Model() == TURB_TRANS_MODEL::LM) transition = true; heat_fvm = config->GetWeakly_Coupled_Heat(); break;
    case MAIN_SOLVER::FEM_EULER : fem_euler = true; break;
    case MAIN_SOLVER::FEM_NAVIER_STOKES: fem_ns = true; break;
    case MAIN_SOLVER::FEM_RANS : fem_ns = true; fem_turbulent = true; if(config->GetKind_Trans_Model() == TURB_TRANS_MODEL::LM) fem_transition = true; break;
    case MAIN_SOLVER::FEM_LES : fem_ns = true; break;
    case MAIN_SOLVER::HEAT_EQUATION: heat_fvm = true; break;
    case MAIN_SOLVER::FEM_ELASTICITY: fem = true; break;
    case MAIN_SOLVER::ADJ_EULER : euler = true; adj_euler = true; break;
    case MAIN_SOLVER::ADJ_NAVIER_STOKES : ns = true; turbulent = (config->GetKind_Turb_Model() != TURB_MODEL::NONE); adj_ns = true; break;
    case MAIN_SOLVER::ADJ_RANS : ns = true; turbulent = true; adj_ns = true; adj_turb = (!config->GetFrozen_Visc_Cont()); break;
    case MAIN_SOLVER::DISC_ADJ_EULER: euler = true; disc_adj = true; break;
    case MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES: ns = true; disc_adj = true; heat_fvm = config->GetWeakly_Coupled_Heat(); break;
    case MAIN_SOLVER::DISC_ADJ_RANS: ns = true; turbulent = true; disc_adj = true; disc_adj_turb = (!config->GetFrozen_Visc_Disc()); heat_fvm = config->GetWeakly_Coupled_Heat(); break;
    case MAIN_SOLVER::DISC_ADJ_FEM_EULER: fem_euler = true; disc_adj = true; break;
    case MAIN_SOLVER::DISC_ADJ_FEM_NS: fem_ns = true; disc_adj = true; break;
    case MAIN_SOLVER::DISC_ADJ_FEM_RANS: fem_ns = true; fem_turbulent = true; disc_adj = true; if(config->GetKind_Trans_Model() == TURB_TRANS_MODEL::LM) fem_transition = true; break;
    case MAIN_SOLVER::DISC_ADJ_FEM: fem = true; disc_adj_fem = true; break;
    case MAIN_SOLVER::DISC_ADJ_HEAT: heat_fvm = true; disc_adj_heat = true; break;
  }
  ...
  switch( config->GetKind_FEM_DG_Shock() ) {
    case FEM_SHOCK_CAPTURING_DG::PERSSON: fem_dg_shock_persson = true; break;
  }
...
void CFEMInterpolationDriver::Solver_Restart(CSolver ****solver_container, CGeometry ***geometry,
  ...
  switch (config->GetKind_Solver()) {
    ...
    case MAIN_SOLVER::NAVIER_STOKES: ns = true; heat_fvm = config->GetWeakly_Coupled_Heat(); break;
    case MAIN_SOLVER::NEMO_NAVIER_STOKES: nemo_ns = true; break;
    case MAIN_SOLVER::RANS : ns = true; turbulent = true; heat_fvm = config->GetWeakly_Coupled_Heat(); break;
    case MAIN_SOLVER::FEM_EULER : fem_euler = true; break;
    case MAIN_SOLVER::FEM_NAVIER_STOKES: fem_ns = true; break;
    case MAIN_SOLVER::FEM_RANS : fem_ns = true; break;
    case MAIN_SOLVER::FEM_LES : fem_ns = true; break;
    case MAIN_SOLVER::HEAT_EQUATION: heat_fvm = true; break;
    case MAIN_SOLVER::FEM_ELASTICITY: fem = true; break;
    case MAIN_SOLVER::ADJ_EULER : euler = true; adj_euler = true; break;
    ...
    case MAIN_SOLVER::DISC_ADJ_FEM_EULER: fem_euler = true; disc_adj = true; break;
    case MAIN_SOLVER::DISC_ADJ_FEM_NS: fem_ns = true; disc_adj = true; break;
    case MAIN_SOLVER::DISC_ADJ_FEM_RANS: fem_ns = true; turbulent = true; disc_adj = true; disc_adj_turb = (!config->GetFrozen_Visc_Disc()); break;
    case MAIN_SOLVER::DISC_ADJ_FEM: fem = true; disc_adj_fem = true; break;
    case MAIN_SOLVER::DISC_ADJ_HEAT: heat_fvm = true; disc_adj_heat = true; break;
...
void CFEMInterpolationDriver::Solver_Deletion(CSolver ****solver_container,
  ...
  switch (config->GetKind_Solver()) {
    ...
    case MAIN_SOLVER::NEMO_NAVIER_STOKES: nemo_ns = true; break;
    case MAIN_SOLVER::RANS : ns = true; turbulent = true; if (config->GetKind_Trans_Model() == TURB_TRANS_MODEL::LM) transition = true; heat_fvm = config->GetWeakly_Coupled_Heat(); break;
    case MAIN_SOLVER::FEM_EULER : euler = true; break;
    case MAIN_SOLVER::FEM_NAVIER_STOKES:
    case MAIN_SOLVER::FEM_LES: ns = true; break;
    case MAIN_SOLVER::FEM_RANS: ns = true; turbulent = true; if (config->GetKind_Trans_Model() == TURB_TRANS_MODEL::LM) transition = true; break;
    case MAIN_SOLVER::HEAT_EQUATION: heat_fvm = true; break;
    case MAIN_SOLVER::FEM_ELASTICITY: fem = true; break;
    case MAIN_SOLVER::ADJ_EULER : euler = true; adj_euler = true; break;
    case MAIN_SOLVER::ADJ_NAVIER_STOKES : ns = true; turbulent = (config->GetKind_Turb_Model() != TURB_MODEL::NONE); adj_ns = true; break;
    ...
    case MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES: ns = true; disc_adj = true; heat_fvm = config->GetWeakly_Coupled_Heat(); break;
    case MAIN_SOLVER::DISC_ADJ_RANS: ns = true; turbulent = true; disc_adj = true; disc_adj_turb = (!config->GetFrozen_Visc_Disc()); heat_fvm = config->GetWeakly_Coupled_Heat(); break;
    case MAIN_SOLVER::DISC_ADJ_FEM_EULER: euler = true; disc_adj = true; break;
    case MAIN_SOLVER::DISC_ADJ_FEM_NS: ns = true; disc_adj = true; break;
    case MAIN_SOLVER::DISC_ADJ_FEM_RANS: ns = true; turbulent = true; disc_adj = true; disc_adj_turb = (!config->GetFrozen_Visc_Disc()); break;
    case MAIN_SOLVER::DISC_ADJ_FEM: fem = true; disc_adj_fem = true; break;
    case MAIN_SOLVER::DISC_ADJ_HEAT: heat_fvm = true; disc_adj_heat = true; break;
  }
  /*--- Assign turbulence model booleans ---*/
                                           ...
                                           unsigned short nZone)
{
  ...
  for(iZone = 0; iZone < nZone; iZone++){
    ...
    switch (config[iZone]->GetKind_Solver()) {
      ...
      case MAIN_SOLVER::EULER : euler = true; break;
      case MAIN_SOLVER::NEMO_EULER: nemo_euler = true; break;
      case MAIN_SOLVER::NAVIER_STOKES: ns = true; heat_fvm = config[iZone]->GetWeakly_Coupled_Heat(); break;
      case MAIN_SOLVER::NEMO_NAVIER_STOKES: nemo_ns = true; break;
      case MAIN_SOLVER::RANS : ns = true; turbulent = true; if (config[iZone]->GetKind_Trans_Model() == TURB_TRANS_MODEL::LM) transition = true; heat_fvm = config[iZone]->GetWeakly_Coupled_Heat(); break;
      case MAIN_SOLVER::FEM_EULER : fem_euler = true; break;
      case MAIN_SOLVER::FEM_NAVIER_STOKES: fem_ns = true; break;
      case MAIN_SOLVER::FEM_RANS : fem_ns = true; fem_turbulent = true; if(config[iZone]->GetKind_Trans_Model() == TURB_TRANS_MODEL::LM) fem_transition = true; break;
      case MAIN_SOLVER::FEM_LES : fem_ns = true; break;
      case MAIN_SOLVER::HEAT_EQUATION: heat_fvm = true; break;
      case MAIN_SOLVER::FEM_ELASTICITY: fem = true; break;
      case MAIN_SOLVER::ADJ_EULER : euler = true; adj_euler = true; break;
      case MAIN_SOLVER::ADJ_NAVIER_STOKES : ns = true; turbulent = (config[iZone]->GetKind_Turb_Model() != TURB_MODEL::NONE); adj_ns = true; break;
      case MAIN_SOLVER::ADJ_RANS : ns = true; turbulent = true; adj_ns = true; adj_turb = (!config[iZone]->GetFrozen_Visc_Cont()); break;
      case MAIN_SOLVER::DISC_ADJ_EULER: euler = true; disc_adj = true; break;
      case MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES: ns = true; disc_adj = true; heat_fvm = config[iZone]->GetWeakly_Coupled_Heat(); break;
      case MAIN_SOLVER::DISC_ADJ_RANS: ns = true; turbulent = true; disc_adj = true; disc_adj_turb = (!config[iZone]->GetFrozen_Visc_Disc()); heat_fvm = config[iZone]->GetWeakly_Coupled_Heat(); break;
      case MAIN_SOLVER::DISC_ADJ_FEM_EULER: fem_euler = true; disc_adj = true; break;
      case MAIN_SOLVER::DISC_ADJ_FEM_NS: fem_ns = true; disc_adj = true; break;
      case MAIN_SOLVER::DISC_ADJ_FEM_RANS: fem_ns = true; fem_turbulent = true; disc_adj = true; if(config[iZone]->GetKind_Trans_Model() == TURB_TRANS_MODEL::LM) fem_transition = true; break;
      case MAIN_SOLVER::DISC_ADJ_FEM: fem = true; disc_adj_fem = true; break;
      case MAIN_SOLVER::DISC_ADJ_HEAT: heat_fvm = true; disc_adj_heat = true; break;
    }
